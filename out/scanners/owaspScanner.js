...
class OWASPScanner {
    ...
    async scan() {
        const issues = [];
        try {
            const files = await vscode.workspace.findFiles('**/*.{js,ts,jsx,tsx,py,php,java,cs,rb,go}', '**/node_modules/**');
    ...
    checkAdditionalVulnerabilities(line, lineNumber) {
        const issues = [];
    ...
    getOWASPDescription(category, match) {
        switch (category) {
...
exports.OWASPScanner = OWASPScanner;
